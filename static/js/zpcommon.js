...
var Zepto = function() {
    ...
    function p(a, b, c) {
        for (x in b)
            c && f(b[x]) ? (f(a[x]) || (a[x] = {}), p(a[x], b[x], c)) : b[x] !== w && (a[x] = b[x])
    }
    function q(a, b) {
    ...
    return Y.matches = function(a, b) {
        ...
        W["[object " + b + "]"] = b.toLowerCase()
    }), y.fn = {forEach: C.forEach, reduce: C.reduce, push: C.push, sort: C.sort, indexOf: C.indexOf, concat: C.concat, map: function(a) {
            ...
            for (var c = this[0]; c && !Y.matches(c, a); )
            ...
            if (a)
                return this.each(function(b) {
                    var c = y(this), d = r(this, a, b, c.offset()), e = c.offsetParent().offset(), f = {top: d.top - e.top, left: d.left - e.left};
                    "static" == c.css("position") && (f.position = "relative"), c.css(f)
                });
            if (0 == this.length)
                return null;
            var b = this[0].getBoundingClientRect();
            return{left: b.left + window.pageXOffset, top: b.top + window.pageYOffset, width: b.width, height: b.height}
        }, css: function(a, b) {
            if (arguments.length < 2 && "string" == typeof a)
                return this[0] && (this[0].style[A(a)] || I(this[0], "").getPropertyValue(a));
            var c = "";
            for (x in a)
                a[x] || 0 === a[x] ? c += k(x) + ":" + m(x, a[x]) + ";" : this.each(function() {
            ...
            if (this.length) {
                var a = this[0], b = this.offsetParent(), c = this.offset(), d = M.test(b[0].nodeName) ? {top: 0, left: 0} : b.offset();
                return c.top -= parseFloat(y(a).css("margin-top")) || 0, c.left -= parseFloat(y(a).css("margin-left")) || 0, d.top += parseFloat(y(b[0]).css("border-top-width")) || 0, d.left += parseFloat(y(b[0]).css("border-left-width")) || 0, {top: c.top - d.top, left: c.left - d.left}
            }
        ...
        y.fn[b] = function() {
            var b, e, f = y.map(arguments, function(c) {
                return b = a(c), "object" == b || "array" == b ? c : Y.fragment(c)
            }), g = this.length > 1;
...
window.Zepto = Zepto, "$"in window || (window.$ = Zepto), function(a) {
    ...
    o.click = o.mousedown = o.mouseup = o.mousemove = "MouseEvents", a.event = {add: i, remove: j}, a.proxy = function(c, d) {
        if (a.isFunction(c)) {
            var e = function() {
    ...
    var q = function() {
        ...
        return!1
    }, s = /^([A-Z]|layer[XY]$)/, t = {preventDefault: "isDefaultPrevented", stopImmediatePropagation: "isImmediatePropagationStopped", stopPropagation: "isPropagationStopped"};
        ...
        return this.each(function(e, f) {
            i(f, c, d, b, function(c) {
                return function(d) {
                    ...
                    if (g)
                        return e = a.extend(k(d), {currentTarget: g, liveFired: f}), c.apply(g, [e].concat([].slice.call(arguments, 1)))
                }
            })
        })
    ...
    var f, g, h, i, j, k, l, m, n = "", o = {Webkit: "webkit", Moz: "", O: "o", ms: "MS"}, p = window.document, q = p.createElement("div"), r = /^((translate|rotate|scale)(X|Y|Z|3d)?|matrix(3d)?|perspective|skew(X|Y)?)$/i, s = {};
    a.each(o, function(a, c) {
        if (q.style[a + "TransitionProperty"] !== b)
            return n = "-" + d(a) + "-", f = c, !1
        ...
        if (e === b && (e = .4), a.fx.off && (e = 0), "string" == typeof d)
            t[k] = d, t[l] = e + "s", t[m] = f || "linear", w = a.fx.animationEnd;
        else {
            p = [];
            for (o in d)
                r.test(o) ? u += o + "(" + d[o] + ") " : (t[o] = d[o], p.push(c(o)));
            u && (t[g] = u, p.push(g)), e > 0 && "object" == typeof d && (t[h] = p.join(", "), t[i] = e + "s", t[j] = f || "linear")
        }
        return q = function(b) {
        ...
        }, e > 0 && this.bind(w, q), this.size() && this.get(0).clientLeft, this.css(t), e <= 0 && setTimeout(function() {
            v.each(function() {
                q.call(this)
            })
        }, 0), this
    ...
    function n(b, c, d, e) {
        ...
        return{url: b, data: f ? c : void 0, success: f ? a.isFunction(d) ? d : void 0 : c, dataType: f ? e || d : d}
    }
    function o(b, c, d, e) {
        var f, g = a.isArray(c);
    ...
    a.active = 0, a.ajaxJSONP = function(b) {
        if ("type"in b) {
            ...
            return m(b), f(l, b) === !1 ? (k("abort"), !1) : (window[d] = function(a) {
                i(), g(a, l, b)
            }, e.onerror = function() {
                k("error")
        ...
        }, accepts: {script: "text/javascript, application/javascript", json: w, xml: "application/xml, text/xml", html: x, text: "text/plain"}, crossDomain: !1, timeout: 0, processData: !0}, a.ajax = function(b) {
        var c = a.extend({}, b || {});
        ...
        c.crossDomain || (r["X-Requested-With"] = "XMLHttpRequest"), o && (r.Accept = o, o.indexOf(",") > -1 && (o = o.split(",", 2)[0]), t.overrideMimeType && t.overrideMimeType(o)), (c.contentType || c.contentType !== !1 && c.data && "GET" != c.type.toUpperCase()) && (r["Content-Type"] = c.contentType || "application/x-www-form-urlencoded"), c.headers = a.extend(r, c.headers || {}), t.onreadystatechange = function() {
            if (4 == t.readyState) {
                ...
                if (t.status >= 200 && t.status < 300 || 304 == t.status || 0 == t.status && "file:" == s) {
                    ...
                    h(null, t.status ? "error" : "abort", t, c)
            }
        };
    ...
    function d(a, b) {
        var c = /^\w+\:\/\//;
        return/^\/\/\/?/.test(a) ? a = location.protocol + a : c.test(a) || "/" == a.charAt(0) || (a = (b || "") + a), c.test(a) ? a : ("/" == a.charAt(0) ? s : r) + a
    }
    function e(a, b) {
        for (var c in a)
    ...
    function f(a) {
        for (var b = !1, c = 0; c < a.scripts.length; c++)
            a.scripts[c].ready && a.scripts[c].exec_trigger && (b = !0, a.scripts[c].exec_trigger(), a.scripts[c].exec_trigger = null);
        return b
    }
    function g(a, b, c, d) {
    ...
    function i(a, b, c, d, e) {
        setTimeout(function() {
            ...
            f = document.createElement("script"), b.type && (f.type = b.type), b.charset && (f.charset = b.charset), e ? z ? (a[p] && v("start script preload: " + i), c.elem = f, y ? (f.preload = !0, f.onpreload = d) : f.onreadystatechange = function() {
            ...
            }, h.open("GET", i), h.send()) : (a[p] && v("start script preload (cache): " + i), f.type = "text/cache-script", g(f, c, "ready", function() {
                t.removeChild(f), d()
    ...
    function j() {
        ...
        function s(a, b, c, e) {
            ...
            b.src = d(b.src, a[q]), b.real_src = b.src + (a[o] ? (/\?.*$/.test(b.src) ? "&_" : "?_") + ~~(1e9 * Math.random()) + "=" : ""), D[b.src] || (D[b.src] = {items: [], finished: !1}), g = D[b.src].items, a[n] || 0 == g.length ? (f = g[g.length] = {ready: !1, finished: !1, ready_listeners: [j], finished_listeners: [k]}, i(a, b, f, e ? function() {
                f.ready = !0;
        ...
        function u() {
            function a(a, b) {
                k[p] && v("script preload finished: " + a.real_src), a.ready = !0, a.exec_trigger = b, g()
            }
            function d(a, b) {
                k[p] && v("script execution finished: " + a.real_src), a.ready = a.finished = !0, a.exec_trigger = null;
                    ...
                    for (var f = 0; f < arguments.length; f++)
                        !function(f, g) {
                            ...
                            for (var n = 0; n < g.length; n++)
                                h(), f = g[n], b(f) && (f = f()), f && (c(f) ? (l = [].slice.call(f), l.unshift(n, 1), [].splice.apply(g, l), n--) : ("string" == typeof f && (f = {src: f}), f = e(f, {ready: !1, ready_cb: a, finished: !1, finished_cb: d}), j.finished = !1, j.scripts.push(f), s(k, f, j, A && o), o = !0, k[m] && i.wait()))
        ...
        var x, y = {}, A = z || B, C = [], D = {};
        return y[l] = !0, y[m] = !1, y[n] = !1, y[o] = !1, y[p] = !1, y[q] = "", x = {setGlobalDefaults: function(a) {
                return e(a, y), x
            }, setOptions: function() {
                ...
                return C[C.length] = {type: "script", args: [].slice.call(arguments)}, x
            }, queueWait: function() {
                return C[C.length] = {type: "wait", args: [].slice.call(arguments)}, x
            }, runQueue: function() {
                for (var a, b = x, c = C.length, d = c; --d >= 0; )
                    a = C.shift(), b = b[a.type].apply(null, a.args);
                return b
            }, noConflict: function() {
                return a.JDLAB = k, x
            }, sandbox: function() {
    ...
    var b = function(b, c, d) {
        ...
        var k = h.styleSheets;
        i.rel = "stylesheet", i.href = b, i.media = d || "screen", e(function() {

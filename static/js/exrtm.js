(function(a) {
    ...
    var b = (function() {
        ...
        c.prototype = {scrollObj: window, refreshTimer: null, duration: 100, _src: "_src", container: "imgContainer", rangeH: 0, animationName: "fade", showDelay: "200", styleContianer: "styleID", imgcb: false, isChangeSize: "true", belowthefold: function(d) {
                ...
                g.onload = function() {
                    ...
                    e.animate({opacity: 1}, d.showDelay)
                };
                g.onerror = function() {
                ...
                var d = this;
                d.loading();
                a(this.scrollObj).on("scroll", function() {
                    if (d.refreshTimer) {
...
function HeaderSlider(a) {
    ...
    this.oBox = {startX: 0, startY: 0, finalX: 0, finalY: 0, endX: 0, endY: 0, sliderX: 0, moveX: 0, tabIndex: 0, numTime: 0, isMove: false, startTime: 0, moveTime: 0, isBottomed: false, isBtmDetail: null}
}
HeaderSlider.prototype = {init: function(c) {
        var c = c || {}, g = this.aLi, b = this.oDiv, f = this.oBox, a = this.oDownloadApp, e = this;
        ...
        this.defaults = {maxBtmY: 57, loadProductFn: false, loadInfoFn: false, loadAssessFn: false, itemPullHtml: '<span class="btm-detail-icon btm-down"></span>下拉回到"商品详情"', itemReleaseHtml: '<span class="btm-detail-icon btm-down"></span>释放回到"商品详情"'};
        ...
        var f = this.aLi, c = this.oDiv, b = this.oUl, d = this.aLiLen, e = document.querySelector(".jd-header");
        clearTimeout(a);
        ...
        var c = this.oDiv, e = this, d = this.oMCommonHeader, g = this.oUserAgent, f = document.querySelector("#commentListId"), b = "onorientationchange" in window, a = b ? "orientationchange" : "resize";
        ...
        var a = this.aLi, n = this.oUl, h = this.oBox, m = this.oWrapper, b = this.oHeaderBarH, f = 0, o = document.querySelector(".hold-div-top").offsetHeight, l = document.querySelector(".hold-div-bottom").offsetHeight, d = document.querySelector(".cart-concern-btm-fixed");
        if (d) {
            f = d.offsetHeight
        } else {
            f = 0
        ...
        if (i) {
            var c = i.target, e = c.getAttribute("value"), g = document.getElementById(e)
        }
        ...
        var a = document.querySelector(".hold-div-top"), c = document.querySelector(".m_common_new_top");
        if (c != null) {
        ...
        d.stopPropagation();
        var c = d.targetTouches[0], a = this.oUl, b = this.oDiv, f = this.oBox;
        f.numTime = 0;
        f.startX = c.pageX;
        f.startY = c.pageY;
        f.isMove = false;
        f.startTime = new Date().getTime();
        HeaderSlider.setStyle(a, {WebkitTransition: "", transition: ""});
        b.addEventListener("touchmove", this, false);
        b.addEventListener("touchend", this, false)
    }, moveHandle: function(m) {
        m.stopPropagation();
        var q = m.targetTouches[0], k = this.oBox, r = this.oUl, f = this.oDiv, p = this.oWrapper, j, i, o = document.documentElement.clientHeight, n = this.defaults.maxBtmY;
        ...
        if (k.tabIndex == 0 && k.isBottomed) {
            ...
            var l = 0;
            var h = Math.min(b, n);
            var d = 0 - h / 2 + Math.max(0, b - n), a = d;
            if (d > 0) {
            ...
            HeaderSlider.setStyle(p, {transform: "translateY(-" + l + "px) translateZ(0px)", WebkitTransform: "translateY(-" + l + "px) translateZ(0px)"})
        }
        ...
        var c = document.documentElement.clientWidth, g = this.aLiLen;
        if (k.isMove) {
            m.preventDefault();
        ...
        r.stopPropagation();
        var s = r.changedTouches[0], f = this.oBox, j = this.oDiv, d = this.aTabTitle, t = this.oDivWidth, c = this.oSiftTab, m = this.oTabs, b = this.oUl, l = this.aLiLen, g = this.oTryme, o = this.oDownloadApp, a = this.oUserAgent, k = this.oMCommonHeader, n = document.documentElement.clientWidth, q = this.oWrapper, h = this;
        f.numTime = 0;
        f.endX = s.pageX;
        f.endY = s.pageY;
        if (f.tabIndex == 0 && f.isBottomed && f.endY - f.startY < -40) {
            ...
            HeaderSlider.setStyle(q, {transform: "translateY(0px) translateZ(0px)", WebkitTransform: "translateY(0px) translateZ(0px)"})
        }
        ...
        var a = this.aTabLi, d = this.oBox, c = this;
        ...
        var a = document.querySelectorAll(".detail"), c = document.querySelectorAll(".tab-lst-a");
        ...
        var a = this, b = this.oTabs;
        if (b) {
            b.addEventListener("click", function(e) {
                var d = e || event, c = d.srcElemnt || d.target;
        ...
        var g = this.aTabLi, i = this.oBox, o = this.aTabTitle, d = this.oSiftTab, f = this.oTabs, m = this.oUl, a = this.aLi, n = this.oTryme, b = this.oDownloadApp, l = this.oMCommonHeader, c = document.documentElement.clientWidth, h = this.oUserAgent;
        i.tabIndex = k;
        if (l != null) {
        ...
        var d = this.oSiftTab, i = this.oBox, a = this.aLi, j = this, o = this.oTryme, b = this.oDownloadApp, g = this.oUserAgent, c = 10, e = 0, m = document.documentElement.clientHeight, n = document.querySelector(".hold-div-top").offsetHeight, l = document.querySelector(".hold-div-bottom").offsetHeight, f = $(".download-block-right")[0], h = document.getElementById("indexToTop");
        ...
        var d = this.oTabs, f = this.oBox, g = this, j = this.oTryme, b = this.oDownloadApp, e = this.oUserAgent, c = 10, i = document.querySelector(".jd-header-new-bar"), h = document.querySelector("#commentListId");
        if (i != null) {
            var a = i.offsetTop
        }
        if (h) {
        ...
        var p = this.oWrapper, a = this.oSiftTab, d = this.oBox, g = this.oDiv, r = this.oHeaderBarH, h = document.querySelector(".header-slider-con").offsetHeight, k = document.querySelector(".cart-concern-btm-fixed").offsetHeight, w = document.documentElement.clientHeight, x = document.getElementById("itemProductHead"), l = document.getElementById("itemDetailHead"), b = 0, n = document.querySelector(".hold-div-top").offsetHeight, m = document.querySelector(".hold-div-bottom").offsetHeight, t = document.getElementById("indexToTop"), v = document.getElementById("btmToTop"), q = document.querySelector(".new-wt"), j = "", e = this;
        d.isBtmDetail = true;
        g.removeEventListener("touchstart", this, false);
        pingClickWithLevel("MProductdetail_PullToDetail", "", "", "", "");
        HeaderSlider.setStyle(q, {backgroundColor: "#fff"});
        if (!itemInfoFlag) {
            productInfoLoad({containerID: "btmDetail", wareId: $("#currentWareId").val(), url: "/ware/detail.json?wareId=" + $("#currentWareId").val(), cbfn: function() {
        ...
        var s = w - k - m - r - u;
        HeaderSlider.setStyle(p, {transform: "translateY(-" + s + "px) translateZ(0px)", WebkitTransform: "translateY(-" + s + "px) translateZ(0px)", transition: "transform 1s cubic-bezier(0, 0, 0.25, 1) 0ms", WebkitTransition: "transform 1s cubic-bezier(0, 0, 0.25, 1) 0ms"});
        setTimeout(function() {
            HeaderSlider.setStyle(p, {transform: "translateY(-" + h + "px) translateZ(0px)", WebkitTransform: "translateY(-" + h + "px) translateZ(0px)", transition: "none", WebkitTransition: "none", height: w + "px"});
            window.scrollTo(0, 0);
            clearInterval(e.setHeightTimer);
            e.setHeightTimer = setInterval(function() {
                ...
                var y = B + r + A + m + i;
                HeaderSlider.setStyle(p, {height: y + "px"})
            }, 1000);
        ...
        new PullLoad($("#btmLoading"), {trigger: $("#btmDetail"), elWindow: $(window), maxY: 73, lessText: e.defaults.itemPullHtml, greaterText: e.defaults.itemReleaseHtml, onReload: function() {
                this.origin();
                e.btmDetailBack();
                pingClickWithLevel("MProductdetail_DragToDetail", "", "", "", "")
            }})
    }, btmDetailBack: function() {
        var e = this.oBox, b = this.oSiftTab, p = this.oWrapper, g = this.oDiv, r = this.oHeaderBarH, a = this.oUserAgent, j = document.getElementById("btmDetail"), h = document.querySelector(".header-slider-con").offsetHeight, k = document.querySelector(".cart-concern-btm-fixed").offsetHeight, v = document.documentElement.clientHeight, w = document.getElementById("itemProductHead"), l = document.getElementById("itemDetailHead"), u = document.getElementById("btmToTop"), m = document.querySelector(".hold-div-bottom").offsetHeight, c = document.querySelector(".jd-header-shortcut"), q = document.querySelector(".new-wt"), i = "", f = this;
        if (c) {
        ...
        HeaderSlider.setStyle(q, {backgroundColor: "#f0f2f5"});
        ...
        HeaderSlider.setStyle(p, {transform: "translateY(-" + s + "px) translateZ(0px)", WebkitTransform: "translateY(-" + s + "px) translateZ(0px)", transition: "transform 1s cubic-bezier(0, 0, 0.25, 1) 0ms", WebkitTransition: "transform 1s cubic-bezier(0, 0, 0.25, 1) 0ms"});
        setTimeout(function() {
            HeaderSlider.setStyle(p, {transform: "translateY(0px) translateZ(0px)", WebkitTransform: "translateY(0px) translateZ(0px)", transition: "none", WebkitTransition: "none", height: d + "px"});
            window.scrollTo(0, n)
        }, 1200);
        if (b) {
            b.style.display = "none"
        ...
        var e = this.oBox, b = this.oSiftTab, n = this.oWrapper, g = this.oDiv, p = this.oHeaderBarH, a = this.oUserAgent, l = this.oDownloadApp, j = document.getElementById("btmDetail"), h = document.querySelector(".header-slider-con").offsetHeight, s = document.getElementById("itemProductHead"), k = document.getElementById("itemDetailHead"), r = document.getElementById("btmToTop"), m = document.querySelector(".hold-div-bottom").offsetHeight, c = document.querySelector(".jd-header-shortcut"), o = document.querySelector(".new-wt"), i = "", f = this;
        if (c) {
        ...
        HeaderSlider.setStyle(o, {backgroundColor: "#f0f2f5"});
        var d = h + p + m + q;
        HeaderSlider.setStyle(n, {transform: "translateY(0px) translateZ(0px)", WebkitTransform: "translateY(0px) translateZ(0px)", transition: "transform 1s cubic-bezier(0, 0, 0.25, 1) 0ms", WebkitTransition: "transform 1s cubic-bezier(0, 0, 0.25, 1) 0ms", height: d + "px"});
        if (b) {
            b.style.display = "none"
        }
        if (k) {
        ...
        var f = this.oSiftTab, a = this.oHeaderBarH, k = this.oWrapper, c = document.getElementById("btmDetail"), d = document.querySelector(".cart-concern-btm-fixed").offsetHeight, l = document.documentElement.clientHeight, m = document.querySelector(".hold-div-top").offsetHeight, j = document.querySelector(".hold-div-bottom").offsetHeight, b = i.target, g = b.getAttribute("value"), h = document.getElementById(g);
        clearInterval(this.setHeightTimer);
        c.style.height = "auto";
        window.scrollTo(0, 0);
        this.setHeightTimer = setInterval(function() {
        ...
        var c = document.querySelectorAll(".arrow-fold"), b = this;
        ...
        var a = document.querySelectorAll(".switch-title"), c = this;
        for (var b = 0; b < a.length; b++) {
            if (a[b]) {
        ...
        var f = this.oBox, d = this, c = document.getElementById("openAppFlagA").value, e = document.getElementById("downloadBM"), a, b;
        if (c) {
            a = 0;
            b = "caseA"
        } else {
        ...
        $(".comment-list").on("click", ".comment-list-item", function() {
            var g = $(this).find(".comment-img-container");
            f.tabIndex = 2;
            d.tabSwitch(f.tabIndex);
            itemPingjiaFlag = false;
            d.toTopMping(f.tabIndex);
            if (g.length == 0) {
                pingClickWithLevel("MProductdetail_OnlyComment", "", "", $("#currentWareId").val(), "5");
                assessListInit({containerID: "tab-wrapper", url: "newCommentsDetail.json", tabIndex: 0, maxCount: 10, cbList: useful, checkParam: $("#commendetailModel").attr("commendetail-data"), evokeType: b})
            } else {
                assessListInit({containerID: "tab-wrapper", url: "newCommentsDetail.json", tabIndex: a, maxCount: 10, cbList: useful, checkParam: $("#commendetailModel").attr("commendetail-data"), evokeType: b})
            }
            if (c) {
                e.style.display = "none"
            }
        });
        $("#orderComment").on("click", function() {
            f.tabIndex = 2;
            d.tabSwitch(f.tabIndex);
            itemPingjiaFlag = false;
            d.toTopMping(f.tabIndex);
            assessListInit({containerID: "tab-wrapper", url: "newCommentsDetail.json", tabIndex: 4, maxCount: 10, cbList: useful, checkParam: $("#commendetailModel").attr("commendetail-data")})
        });
        ...
        $(".detailInfoClick").on("click", function() {
            f.tabIndex = 1;
        ...
        $("#bottomTipFloor").on("click", function() {
            d.btmDetailJump()
        })
    }, aShortcutClick: function() {
        var e = this.oBox, g = this.oWrapper, b = document.querySelectorAll(".jd-header-icon-shortcut"), h = document.querySelector(".jd-header-shortcut"), j = 0, a, d, f = this;
        ...
        var a = document.getElementById("indexToTop"), b = this.oSiftTab, d = this.oTabs, f = this.oBox, c = this.oMCommonHeader, e = $(".download-block-right")[0];
        if (a) {
        ...
        var b = document.getElementById("btmToTop"), a = this;
        if (b) {
...
HeaderSlider.extend(HeaderSlider, {setStyle: function(c, b) {
        for (var a in b) {
            c.style[a] = b[a]
        }
        ...
        HeaderSlider.setStyle(b, {WebkitTransition: "500ms ease", transition: "500ms ease"});
        HeaderSlider.setStyle(b, {WebkitTransform: "translate3d(" + a + "px,0,0)", transform: "translate3d(" + a + "px,0,0)"})
    }, moving: function(b, a) {
        HeaderSlider.setStyle(b, {transform: "translate3d(" + a + "px,0,0)", WebkitTransform: "translate3d(" + a + "px,0,0)"})
...
var slide = (function() {
    ...
    b.prototype = {init: function(c) {
            var e = this;
            var c = c || {}, d = this.aLi;
            this.defaults = {imgSrc: "imgsrc", startIndex: 0, loop: false, smallBtn: false, number: false, laseMoveFn: false, location: false, preDef: "lnr", autoPlay: false, autoHeight: false, preFn: null, lastImgSlider: false, playTime: 6000, mpingEvent: "", wareId: "", callback: null, verticalCenter: false, fullScreen: true, total: 0, isBanOneImg: true, whRatio: 1, numberWrapId: null};
            ...
            var d = this.aLi, g = d.length, o = this.oUl, m = this.oBox, c = 320, e = this.now, f = document.documentElement.clientWidth, n = this.defaults.whRatio, l = this;
            if (this.defaults.preFn) {
                this.defaults.preFn()
            }
            for (var j = 0; j < g; j++) {
                b.setStyle(d[j], {WebkitTransition: "all 0ms ease", transition: "all 0ms ease", height: "auto"})
            }
            ...
            if (this.defaults.loop) {
                for (var j = 0; j < g; j++) {
                    b.setStyle(d[j], {position: "absolute", left: 0, top: 0});
                    if (j == b.getNow(e, g)) {
                        l.loadImg(d[j]);
                        b.setStyle(d[j], {WebkitTransform: "translate3d(" + 0 + "px, 0px, 0px)", transform: "translate3d(" + 0 + "px, 0px, 0px)", zIndex: 10})
                    } else {
                        if (j == b.getPre(e, g)) {
                            b.setStyle(d[j], {WebkitTransform: "translate3d(" + -c + "px, 0px, 0px)", transform: "translate3d(" + -c + "px, 0px, 0px)", zIndex: 10})
                        } else {
                            if (j == b.getNext(e, g)) {
                                b.setStyle(d[j], {WebkitTransform: "translate3d(" + c + "px, 0px, 0px)", transform: "translate3d(" + c + "px, 0px, 0px)", zIndex: 10})
                            } else {
                                if (j == b.getNextNew(e, g)) {
                                    b.setStyle(d[j], {WebkitTransform: "translate3d(" + c * 2 + "px, 0px, 0px)", transform: "translate3d(" + c * 2 + "px, 0px, 0px)", zIndex: 10})
                                } else {
                                    b.setStyle(d[j], {WebkitTransform: "translate3d(" + -c + "px, 0px, 0px)", transform: "translate3d(" + -c + "px, 0px, 0px)", zIndex: 9})
                                }
                            }
                        }
                    }
                ...
                for (var j = 0; j < g; j++) {
                    b.setStyle(d[j], {WebkitTransform: "translate3d(" + e * -c + "px, 0px, 0px)", transform: "translate3d(" + e * -c + "px, 0px, 0px)"})
                }
            }
        }, setWhFn: function(c, g) {
            var j = this.aLi, f = j.length, d = this.oUl, h = this.oBox;
            h.style.width = c + "px";
            ...
            this.on0ff = true;
            var d = b._device(), f = d.hasTouch, h = this.oBox, c = this.now, g = this.aLi;
            ...
            var n = this.oBox, e = b._device();
            if (this.on0ff) {
                var o = e.hasTouch;
                var j = o ? q.targetTouches[0].pageX : q.clientX - n.offsetLeft;
                var h = o ? q.targetTouches[0].pageY : q.clientY - n.offsetTop;
                var c = this.aLi, g = c.length, d = this.now, t = c[0].offsetWidth;
                if (this.defaults.preDef == "all") {
                    b.stopDefault(q)
                }
                for (var m = 0; m < g; m++) {
                    b.setStyle(c[m], {WebkitTransition: "all 0ms ease", transition: "all 0ms ease"})
                }
            ...
            i.stopPropagation();
            this.on0ff = false;
            var f = Date.now(), e = b._device(), h = e.hasTouch, g = this.oBox, l = h ? i.changedTouches[0].pageX : i.clientX - g.offsetLeft, k = h ? i.changedTouches[0].pageY : i.clientY - g.offsetTop, c = this.aLi, j = c[0].offsetWidth, d = b.getTranX(c[b.getNow(this.now, c.length)]);
            ...
            var c = this.aLi, k = c.length, r = c[0].offsetWidth, q = this.oBox, g = b._device(), p = this, d = this.now;
            ...
            if (this.defaults.loop) {
                ...
                for (var o = 0; o < k; o++) {
                    if (o == b.getPre(d, k)) {
                        ...
                        b.setStyle(c[b.getPre(d, k)], {WebkitTransform: "translate3d(" + -r + "px, 0px, 0px)", transform: "translate3d(" + -r + "px, 0px, 0px)", zIndex: 10, WebkitTransition: "all " + h + "ms ease", transition: "all " + h + "ms ease"})
                    } else {
                        if (o == b.getNow(d, k)) {
                            b.setStyle(c[b.getNow(d, k)], {WebkitTransform: "translate3d(" + 0 + "px, 0px, 0px)", transform: "translate3d(" + 0 + "px, 0px, 0px)", zIndex: 10, WebkitTransition: "all " + 300 + "ms ease", transition: "all " + 300 + "ms ease"})
                        } else {
                            if (o == b.getNext(d, k)) {
                                var h = 300;
                                switch (l) {
                                ...
                                b.setStyle(c[b.getNext(d, k)], {WebkitTransform: "translate3d(" + r + "px, 0px, 0px)", transform: "translate3d(" + r + "px, 0px, 0px)", zIndex: 10, WebkitTransition: "all " + h + "ms ease", transition: "all " + h + "ms ease"})
                            } else {
                                if (o == b.getNextNew(d, k)) {
                                    ...
                                    b.setStyle(c[b.getNextNew(d, k)], {WebkitTransform: "translate3d(" + r * 2 + "px, 0px, 0px)", transform: "translate3d(" + r * 2 + "px, 0px, 0px)", zIndex: 10, WebkitTransition: "all " + h + "ms ease", transition: "all " + h + "ms ease"})
                                } else {
                                    b.setStyle(c[o], {WebkitTransform: "translate3d(" + r * 2 + "px, 0px, 0px)", transform: "translate3d(" + r * 2 + "px, 0px, 0px)", zIndex: 9, WebkitTransition: "all " + 0 + "ms ease", transition: "all " + 0 + "ms ease"})
                                }
                            }
                        }
                    }
                ...
                for (var o = 0; o < k; o++) {
                    b.setStyle(c[o], {WebkitTransition: "all " + 300 + "ms ease", transition: "all " + 300 + "ms ease"})
                }
                if (d <= 0) {
                    d = 0;
                    this.now = 0
                ...
                for (var n = 0; n < k; n++) {
                    b.setStyle(c[n], {WebkitTransform: "translate3d(" + (-d * r) + "px, 0px, 0px)", transform: "translate3d(" + (-d * r) + "px, 0px, 0px)"})
                }
            }
            if (this.defaults.smallBtn) {
    ...
    b.extend(b, {setStyle: function(d, c) {
            for (name in c) {
                d.style[name] = c[name]
            }
        }, getTranX: function(e) {
            ...
            var e = "touchmove";
            var c = "touchend";
            return{hasTouch: f, startEvt: d, moveEvt: e, endEvt: c}
        }, getNow: function(d, c) {
            return d % c
        }, getPre: function(e, c) {
            if (e % c - 1 < 0) {
            ...
            b.setStyle(f, {WebkitTransform: "translate3d(" + d + "px, 0px, 0px)", transform: "translate3d(" + d + "px, 0px, 0px)"})
...
var slideshow = (function() {
    ...
    function a(c) {
        ...
        this.oBox = {startX: 0, startY: 0, finalX: 0, finalY: 0, endX: 0, endY: 0, sliderX: 0, sliderDirection: 1, moveX: 0, abortSlider: false, numTime: 0, isMove: false, oneWidthNum: 0}
    }
    a.prototype = {init: function(d) {
            var d = d || {};
            this.defaults = {lineNum: 1, marginValue: 0, fullScreen: false, multiMove: false, singleMove: false, isRight: false, isMove: false, isSymmetry: false, wrapperLeft: 0, smallBtn: false, startIndex: 0, UlMarRight: 0, mpingEvent: null, mpingFn: null};
            ...
            var e = this.oDiv, d = "onorientationchange" in window, c = d ? "orientationchange" : "resize";
            e.addEventListener("touchstart", this, false);
            window.addEventListener(c, this, false)
        }, setItems: function() {
            var d = this.oDiv, h = this.aLi, c = this.oUl, g = this.oBox;
            ...
            g.stopPropagation();
            var f = g.targetTouches[0], d = this.oDiv, c = this.oUl, h = this.oBox;
            h.startX = f.pageX;
            h.startY = f.pageY;
            h.numTime = 0;
            h.isMove = false;
            ...
            a.setStyle(c, {WebkitTransition: "", transition: ""});
            d.addEventListener("touchmove", this, false);
            d.addEventListener("touchend", this, false)
        }, moveHandler: function(j) {
            j.stopPropagation();
            var k = j.touches[0], i = this.oBox, m = this.oUl, c = this.aLi, f = this.oUlWidth, l = this.oDivWidth, d = document.documentElement.clientWidth, h = this, g;
            if (i.abortSlider) {
                return
            }
            if (i.numTime === 0) {
            ...
            l.stopPropagation();
            var m = l.changedTouches[0], f = this.oDiv, n = this.oDivWidth, d = this.oUlWidth, i = this.eachScreenWidth, k = this.oBox, o = this.oUl, g = this.oLiWidth, h = this.oLiItemWidth, j = this, q = 0, c = 0, p;
            k.endX = m.pageX;
            k.endY = m.pageY;
            if (k.abortSlider) {
                return
            ...
            var g = this.oBox, c = this.oUl, d = this, f = window.navigator.userAgent;
            g.sliderX = 0;
            a.sliding(c, g.sliderX);
            clearTimeout(e);
            var e = setTimeout(function() {
                if (f.indexOf("OS 8") != -1 && f.indexOf("Safari") != -1) {
                    var j = document.documentElement.clientWidth, i = document.querySelector(".cart-menu-content");
                    if (i) {
                        i.style.width = j + "px"
                    }
                }
            ...
            var h = "", c = 0, k = this.aLi, j = this.oBox, g = this.eachScreenNum, d = this.oDivWidth, f = this.oUlWidth;
            if (this.defaults.fullScreen) {
                c = Math.ceil(f / d)
            } else {
            ...
            var f = this.oDiv, e = f.querySelectorAll(".jd-slider-btnDiv span"), k = this.oBox, c = this.oLiItemWidth, d = this.oDivWidth, h = this.eachScreenNum, j = 0;
            if (e.length !== 0) {
                if (this.defaults.fullScreen) {
    ...
    a.extend(a, {setStyle: function(e, d) {
            for (var c in d) {
                e.style[c] = d[c]
            }
            ...
            a.setStyle(d, {WebkitTransition: "500ms ease", transition: "500ms ease"});
            a.setStyle(d, {WebkitTransform: "translate3d(" + c + "px,0,0)", transform: "translate3d(" + c + "px,0,0)"})
        }, moving: function(d, c) {
            a.setStyle(d, {transform: "translate3d(" + c + "px,0,0)", WebkitTransform: "translate3d(" + c + "px,0,0)"})
...
(function(b) {
    ...
    var a = (function() {
        ...
        c.prototype = {cls: null, titleName: null, message: null, delay: 2000, styleType: 1, el: null, container: null, listContainer: null, timer: null, width: 0, height: 0, autoClose: true, isMaskClose: true, scrollH: "", bodyH: "", maxHeight: 0, islimitHeight: true, btns: {cancelTxt: "取消", okTxt: "提交"}, okCallback: function() {
            }, show: function() {
                var d = this;
                var g = this.addHtml();
                this.el = b(g).get(0);
                ...
                switch (d.styleType) {
                    case 1:
                        ...
                        break;
                    case 2:
                        b(".btn-close").bind("click", function() {
                            d.hide()
                        });
                        b(".btn-sure").bind("click", function() {
                            d.okCallback();
                            d.hide()
                        });
                        break;
                    case 3:
                        b(".btn-cancel").bind("click", function() {
                            d.hide()
                        });
                        b(".btn-ok").bind("click", function() {
                            d.okCallback();
                            d.hide()
                        });
                        break;
                    case 4:
                        b(".one-btn-tip-btn").bind("click", function() {
                            d.hide()
                        });
                        break;
                    default:
                ...
                g.css({maxHeight: d.maxHeight, overflowX: "hidden", overflowY: "auto"})
            }, setBody: function(g) {
                var e = this;
                var d = document.documentElement.clientHeight;
                var f = b(e.listContainer);
                if (g == 1) {
                    f.css({height: d, overflow: "hidden"})
                } else {
                    if (g == 2) {
                        f.css({height: e.bodyH, overflow: ""});
...
(function(d) {
    ...
    localStorageUtil = function() {
        ...
        function g() {
            if (h) {
                b.each(window.localStorage, function(l, m, k, j) {
                    window.localStorage.removeItem(k)
                })
            }
        }
        return{get: f, set: i, remove: e, removeAll: g}
    };
    sessionStorageUtil = function() {
        ...
        function g() {
            if (h) {
                b.each(window.sessionStorage, function(l, m, k, j) {
    ...
    var b = {$mObj: {}, merge: function(g, f, e) {
...
(function(a) {
    a.fn.generateRegionList = function(e) {
        ...
        var g = {init: function() {
                ...
                if (m > 2) {
                    a.ajax({dataType: "json", url: g.regionUrl(m), cache: false, beforeSend: function() {
                            g.showLoading()
                        }, success: function(o) {
                            var n = o;
                            setTimeout(function() {
                ...
                if (k && "true" == k && q == 1 && e.initFlag && a("#pin") && a("#pin").val()) {
                    ...
                    a.ajax({dataType: "json", url: m, timeout: 5000, cache: false, success: function(y) {
                            var x = "";
                ...
                m.on(h, function() {
                    ...
                    a.ajax({dataType: "json", url: q, cache: false, beforeSend: function() {
                            g.showLoading()
                        }, success: function(w) {
                            g.hideLoading();
                            d = false;
...
LoadPage.prototype = {init: function(a) {
        var b = {containId: "body", pointHeight: "600", currentP: 1, baseUrl: "", reqPara: "", beforeFn: null, successFn: null, errorFn: null, reLoad: true, isRepeatReq: false, pageNo: "offset", isInit: true, maxHeightFlag: 0, checkParam: ""};
        ...
        var c = "click", b = window.navigator.userAgent;
        var a = {init: function() {
                a.scrollEvt();
                a.toTopEvt()
            }, toTopEvt: function() {
        ...
        var c = "click", b = window.navigator.userAgent, f = this;
        var a = {init: function() {
                a.scrollEvt();
                a.toTopEvt()
            }, toTopEvt: function() {
                ...
                f.objContain.addEventListener("scroll", function() {
        ...
        $.ajax({url: a, type: d.settings.reqType, dataType: "json", data: c, beforeSend: d.settings.beforeFn, success: function(e) {
...
var PullLoad = function(c, b) {
    var g = {trigger: $("body"), elWindow: $(window), maxY: 40, lessText: "下拉回到上一页", greaterText: "释放回到上一页", onReload: function() {
        }};
    var h = $.extend({}, g, b || {});
    if (!c || !c.length) {
        return this
    ...
    a.callback = {reload: h.onReload};
    var f = h.elWindow;
    var e = h.maxY;
    var d = {};
    h.trigger.on({touchstart: function(j) {
            var i = j.touches[0] || j;
            d.posY = i.pageY;
            d.nowY = d.posY;
            d.distanceY = 0;
            ...
            if (d.markY > 0 && c.data("loading") != true) {
                ...
                var j = 0 - i / 2 + Math.max(0, m - e), k = j;
                if (j > 0) {
                    k = a.damping(j);
                ...
                c.css({height: i, borderBottomWidth: k, transition: "none"})
            }
            d.rectY = m
        }, touchend: function() {
            if (d.touching !== true) {
            ...
            if (d.markY > 0 && d.rectY > 0) {
                if (d.rectY >= e) {
                    c.data("loading", true).css({transition: "", borderBottomWidth: 0});
                    h.onReload.call(a)
                } else {
                    a.origin()
                }
...
PullLoad.prototype.origin = function() {
    var a = this;
    var b = a.el;
    b.css({transition: "", borderBottomWidth: 0, height: 0}).data("loading", false);
    return a
};
